...
var LayoutGroup = ({
    ...
    const memoizedContext = (0, import_react14.useMemo)(() => ({ ...context.current,
        forceRender
    }), [key]);
...
function MotionConfig({
    ...
    config = { ...(0, import_react17.useContext)(MotionConfigContext),
        ...config
    };
...
function buildHTMLStyles(state2, latestValues, transformTemplate) {
    ...
    if (hasTransformOrigin) {
        const {
            originX = "50%", originY = "50%", originZ = 0
        } = transformOrigin;
...
function createUseRender(forwardMotionProps = false) {
    const useRender = (Component3, props, ref, {
        ...
        const elementProps = Component3 !== import_react27.Fragment ? { ...filteredProps,
            ...visualProps,
            ref
        } : {};
        const {
...
function setTarget(visualElement, definition) {
    ...
    let {
        transitionEnd = {}, transition = {}, ...target
    } = resolved || {};
    target = { ...target,
        ...transitionEnd
    };
...
var MainThreadAnimation = class extends BaseAnimation {
    ...
    initPlayback(keyframes$1) {
        const {
            type = "keyframes", repeat = 0, repeatDelay = 0, repeatType, velocity = 0
        } = this.options;
    ...
    play() {
        ...
        if (this.isStopped)
            return;
        const {
            driver = frameloopDriver, onPlay, startTime
        } = this.options;
        if (!this.driver) {
...
var AcceleratedAnimation = class extends BaseAnimation {
    ...
    initPlayback(keyframes2, finalKeyframe) {
        let {
            duration = 300, times, ease: ease2, type, motionValue: motionValue2, name, startTime
        } = this.options;
        ...
        const animation = startWaapiAnimation(motionValue2.owner.current, name, keyframes2, { ...this.options,
            duration,
            times,
            ease: ease2
        });
...
function animateTarget(visualElement, targetAndTransition, {
    ...
    var _a;
    let {
        transition = visualElement.getDefaultTransition(), transitionEnd, ...target
    } = targetAndTransition;
...
function animateVariant(visualElement, variant, options = {}) {
    ...
    const getChildAnimations = visualElement.variantChildren && visualElement.variantChildren.size ? (forwardDelay = 0) => {
        const {
            delayChildren = 0, staggerChildren, staggerDirection
        } = transition;
...
function MeasureLayout(props) {
    ...
    return (0, import_jsx_runtime8.jsx)(MeasureLayoutWithContext, { ...props,
        layoutGroup,
...
function animateSubject(subject, keyframes2, options, scope) {
    ...
    if (isSingleValue(subject, keyframes2)) {
        ...
        for (let i = 0; i < numSubjects; i++) {
            ...
            animations2.push(...animateTarget(visualElement, { ...keyframes2,
                transition
            }, {}));
        }
    }
...
function startOptimizedAppearAnimation(element, name, keyframes2, options, onReady) {
    ...
    if (!readyAnimation) {
        readyAnimation = startWaapiAnimation(
            element,
            name, [keyframes2[0], keyframes2[0]],
            /**
...
function ReorderGroupComponent({
    ...
    return (0, import_jsx_runtime10.jsx)(Component3, { ...props,
        ref: externalRef,
        ignoreStrict: true,
